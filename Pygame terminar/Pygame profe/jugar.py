...
vida_imagen = pygame.image.load("Pygame profe\Assets\lasvidas.png")  # Asegúrate de tener la imagen en el directorio correcto
...
fondo = pygame.image.load("Pygame profe\Assets\IMG_4557.webp")
...
def mostrar_juego(pantalla: pygame.Surface, cola_eventos: list[pygame.event.Event], datos_juego: dict) -> str:
    ...
    #para mostrar las vidas como imagenes
